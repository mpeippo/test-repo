// Arduino BME280 library API. Source C API is defined at:
...
let BME280 = {
  ...
  _proto: {
	...
	readTemperature: function() {
		...
		return BME280._rt(this.bme) / 100.0;
	},
	...
	readPressure: function() {
		...
		return BME280._rp(this.bme) / 10000.0;
	},
	...
	readHumidity: function() {
		...
		return BME280._rh(this.bme) / 100.0;
	},
	...
	readAltitude: function(lvl) {
		...
		return BME280._ra(this.bme, Math.round(lvl * 100.0)) / 100.0;
	},
	...
	seaLevelForAltitude: function(alt, pres) {
		// C-functions input and output values of “1234” equals 12.34.
		return BME280._alfa(this.bme, Math.round(alt * 100.0), Math.round(pres * 100.0)) / 100.0;
	},
  },
